      ...
      * DATA.......: 06 / 08 / 2024
      *-----------------------------------------------------------------*
      * OBJETIVO...:   IMPRIMIR UM RELATORIO DOS ASSINANTE DE STREAMING
      *
      *-----------------------------------------------------------------*
      ...
      *-----------------------------------------------------------------*
       FILE-CONTROL.
           ...
           SELECT RELATO ASSIGN TO
               "C:\CURSOLOGICA\COBOL\RELATORIOS\RELATO2.TXT"
      ...
      *-----------------------------------------------------------------*
       ...
       01  FS-RELATO                   PIC X(002)          VALUE SPACES.
      *-----------------------------------------------------------------*
      *------------------------- DETALHE -------------------------------*
       01  WRK-DETALHE.
           ...
           05 WRK-DET-ASSIN            PIC 9(003)V99       VALUE ZEROS.
      ...
      *------------------------- CABECALHO 4 ----------------------------*
       01  WRK-CABEC4.
           05  MSG-SUBTOTAL             PIC X(060)         VALUE
           "SUB-TOTAL DA PAGINA".
           05  ACU-SUBTOTAL             PIC 9(003)V99      VALUE ZEROS.
      *------------------------- CABECALHO 5 ----------------------------*
       01  WRK-CABEC5.
           05  MSG-TOTAL                PIC X(060)         VALUE
           "TOTAL DO RELATORIO".
           05  ACU-TOTAL                PIC 9(03)V99       VALUE ZEROS.
      ...
      *-----------------------------------------------------------------*
           ...
           ADD WRK-DET-ASSIN     TO ACU-SUBTOTAL.
